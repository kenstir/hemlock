...
//        Log.setProvider(new StdoutLogProvider());
    ...
    private ArrayList<MBRecord> makeArrayFromJson(String json) throws JSONException {
    ...
    public void test_makeArray1() throws Exception {
        ...
        ArrayList<MBRecord> records = makeArrayFromJson(json);
        assertEquals(2, records.size());
        assertEquals((Integer) 32673, records.get(0).id);
    }
    ...
    public void test_makeArray2() throws Exception {
        ...
        ArrayList<MBRecord> records = makeArrayFromJson(json);
        assertEquals(2, records.size());
        assertEquals((Integer) 503610, records.get(0).id);
        assertEquals((Integer) 502717, records.get(1).id);
    }
    ...
    public void test_makeArray3() throws Exception {
        ...
        ArrayList<MBRecord> records = makeArrayFromJson(json);
        assertEquals(2, records.size());
        assertEquals((Integer) 1805532, records.get(0).id);
        assertEquals((Integer) 2385399, records.get(1).id);
    }
}
