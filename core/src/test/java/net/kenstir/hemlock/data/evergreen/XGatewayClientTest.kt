...
class XGatewayClientTest {
    ...
    fun test_fetch_withCaching() = runTest {
        ...
        val response2 = XGatewayClient.fetch(Api.ACTOR, Api.ORG_UNIT_RETRIEVE, paramListOf(Api.ANONYMOUS, 1), true)
    ...
    fun test_fetch_withCachingDisabled() = runTest {
        val response1 = XGatewayClient.fetch(Api.ACTOR, Api.ILS_VERSION, paramListOf(), false)
        ...
        val response2 = XGatewayClient.fetch(Api.ACTOR, Api.ILS_VERSION, paramListOf(), false)
