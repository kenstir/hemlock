...
import net.kenstir.hemlock.data.evergreen.HOLD_TYPE_COPY
import net.kenstir.hemlock.data.evergreen.HOLD_TYPE_FORCE
import net.kenstir.hemlock.data.evergreen.HOLD_TYPE_METARECORD
import net.kenstir.hemlock.data.evergreen.HOLD_TYPE_PART
import net.kenstir.hemlock.data.evergreen.HOLD_TYPE_RECALL
