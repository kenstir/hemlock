...
interface CircService {
    ...
    suspend fun placeHoldAsync(account: Account, holdType: String, recordId: Int, pickupLib: Int, emailNotify: Boolean, phoneNotify: String?, smsNotify: String?, smsCarrierId: Int?, expireTime: String?, suspendHold: Boolean, thawDate: String?): Result<OSRFObject>
