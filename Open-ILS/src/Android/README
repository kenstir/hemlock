...
Please read the android official documentation on localization : http://developer.android.com/guide/topics/resources/localization.html For supporting france, just create the values-fr directory in the res folder and place the strings.xml (translate it’s content, only the values of the strings) ad you are ready to go.
